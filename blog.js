...
// Asumiendo que cada postit tiene un id único como data-id
...
document.querySelectorAll('.postit').forEach(postit => {
  ...
  postit.ondragstart = () => false; // evitar el drag nativo

  // Restaurar color y posición al cargar
  const id = postit.dataset.id;
